$(document).ready(function () {
  ...
  const animationScript = ["Digital Marketer", "Influencer", "Content Creator"];
...
// Initialize EmailJS
(function(){
  emailjs.init("XX5SqH3YqO1osZBlN"); // Ganti dengan User ID EmailJS Anda
})();
...
document.getElementById('contact-form').addEventListener('submit', function(event) {
  ...
  const serviceID = 'service_zawqh7a'; // Ganti dengan ID layanan yang sesuai
  const templateID = 'template_a8vrvod'; // Ganti dengan ID template yang sesuai
